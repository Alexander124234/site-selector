...
echo [13] Gmail - Mail Server
echo [14] Twitter - social networking
echo [15] foxnews - News
echo [16] Twitch - video live streaming
echo [17] Amazon - online store
echo [18] TikTok - video-sharing social networking service
echo [19] Fandom - wiki
echo [20] Netflix - media services
echo.
echo [e] Exit
echo.
echo ***************************************************************
...
if %udefine%==13 start https://mail.google.com
if %udefine%==14 start https://twitter.com
if %udefine%==15 start https://www.foxnews.com
if %udefine%==16 start https://www.twitch.tv
if %udefine%==17 start https://www.amazon.com
if %udefine%==18 start https://www.tiktok.com
if %udefine%==19 start https://www.fandom.com
if %udefine%==20 start https://www.netflix.com
